...
// Fonction pour créer les ennemis du niveau 2 - 14 ennemis : 7 champignons, 5 goblins, 1 tréant, 1 diable
export const createLevel2Enemies = (): Enemy[] => {
  ...
  const enemySpawnTimes = [
    ...
    16000, // Ennemi 10 : diable après 16 secondes
